...
pub struct OrbitWarsV8CudaDeviceBatchView {
    ...
    pub labels_fire: *mut i32,
    pub labels_source: *mut i32,
    pub labels_target: *mut i32,
    pub labels_amount: *mut i32,
    pub labels_confidence: *mut f32,
...
impl Default for OrbitWarsV8CudaDeviceBatchView {
    fn default() -> Self {
        Self {
            ...
            labels_fire: std::ptr::null_mut(),
            labels_source: std::ptr::null_mut(),
            labels_target: std::ptr::null_mut(),
            labels_amount: std::ptr::null_mut(),
            labels_confidence: std::ptr::null_mut(),
            request_count: 0,
            token_count: 0,
            token_features: 0,
            planet_count: 0,
