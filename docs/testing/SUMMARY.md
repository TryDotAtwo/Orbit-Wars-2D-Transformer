...
- `test_results/2026-06-03_lightweight_replay_history.md`: trainer replay history stores chunk metadata instead of full completed replay payloads; targeted Rust test and full Rust workspace passed.
